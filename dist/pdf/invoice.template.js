...
const logo = fs_1.default.readFileSync(path_1.default.join(__dirname, "../assets/logo.png"));
...
class InvoiceTemplate {
    static render(invoice = {}) {
        const formatMoney = (value = 0) => `${(Number(value) / 1000).toLocaleString("en-US")} IQD`;
        const statusMap = {
            unpaid: "غير مدفوعة",
            paid: "مدفوعة",
        };
